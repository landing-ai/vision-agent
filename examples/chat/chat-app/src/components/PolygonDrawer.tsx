...
import { PlusCircle, Undo2, Trash2 } from "lucide-react";
...
const PolygonDrawer: React.FC<PolygonDrawerProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col items-end space-y-3 z-10">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-5 py-3 transition-colors duration-200 border-b border-gray-100
              ${currentPoints.length >= 3 
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-5 py-3 text-purple-600 hover:bg-purple-50 transition-colors duration-200 border-t border-gray-100"
          >
          ...
          <div className="p-4">
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {polygons.map((polygon) => (
                <li
                  key={polygon.id}
                  className="group relative flex items-center gap-3 p-3 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-100 rounded-md hover:shadow-md transition-all duration-200"
                >
